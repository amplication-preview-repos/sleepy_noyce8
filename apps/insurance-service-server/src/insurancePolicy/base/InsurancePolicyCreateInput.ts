...
@InputType()
class InsurancePolicyCreateInput {
  @ApiProperty({
    required: false,
    type: () => ClaimCreateNestedManyWithoutInsurancePoliciesInput,
  })
  @ValidateNested()
  @Type(() => ClaimCreateNestedManyWithoutInsurancePoliciesInput)
  @IsOptional()
  @Field(() => ClaimCreateNestedManyWithoutInsurancePoliciesInput, {
    nullable: true,
  })
...
export { InsurancePolicyCreateInput as InsurancePolicyCreateInput };
