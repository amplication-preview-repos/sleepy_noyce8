...
@InputType()
class InsurancePolicyCreateNestedManyWithoutCustomersInput {
...
export { InsurancePolicyCreateNestedManyWithoutCustomersInput as InsurancePolicyCreateNestedManyWithoutCustomersInput };
