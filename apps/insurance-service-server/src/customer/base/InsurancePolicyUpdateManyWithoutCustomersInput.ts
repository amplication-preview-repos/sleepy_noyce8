...
@InputType()
class InsurancePolicyUpdateManyWithoutCustomersInput {
...
export { InsurancePolicyUpdateManyWithoutCustomersInput as InsurancePolicyUpdateManyWithoutCustomersInput };
